...
gss = client.open_by_key("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx") #General Chemistry

pss = client.open_by_key("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx") #Physical Chemistry

iss = client.open_by_key("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx") #Inorganic Chemistry
...
for file_selected in filenames:
    ...
    if path.exists("Transcribed Pages\\" + file_name):
        ...
        if "X" in account_text:
            ss = iss
        elif "Y" in account_text:
            ss = pss
        elif "Z" in account_text:
            ss = gss
        else:
